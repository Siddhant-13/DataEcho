...
import { Mic, MicOff, Upload, HelpCircle, Loader2, CheckCircle2, XCircle } from "lucide-react";
          ...
          <Dialog open={isHelpOpen} onOpenChange={setIsHelpOpen}>
            ...
            <DialogContent>
              ...
              <div className="space-y-4 text-sm mt-2">
                <p>
                  Chart Whisper helps you analyze charts through voice or text interaction.
